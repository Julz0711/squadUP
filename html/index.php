    ...
    <main class="main">
        ...
        <section id="intro">
            ...
            <div class="sec_1">
                ...
                <div class="captions">
                    <h1 class="main_cap">Triff neue Freunde!<br>
                        Findet Euer Team!<br>
        ...
        <section id="product">
            <div class="register_wrapper">
                ...
                <h3 class="sec_subheader" style="margin-top:32px;">Erstelle kostenlos in sekundenschnelle deinen
                    persönlichen
                    squadUP Account und lerne direkt neue Menschen und Sportarten kennen!</h3>

                <a href="../php/register.php" id="dm-btn" class="registerBt">
...
<!-- TO DO html, css, javascript
    ...
    - Header DONE
    - Content Boxes DONE
    - Nav Bar stay on top with shadow on start scroll
